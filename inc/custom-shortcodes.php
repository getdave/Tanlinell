...
function tanlinell_developer_credit( $atts=array() ) {
	...
	// Allow developer to filter the args (useful for child themes!)
	extract( shortcode_atts( $defaults, apply_filters( 'tanlinell_developer_credit_args', $atts ) ) );
