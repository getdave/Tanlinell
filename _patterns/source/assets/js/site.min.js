...
(function($) {
    var TanlinellResponsiveMaps = function(el, options) {
        this.el = el[0];
        this.$el = $(this.el);
        this.map = undefined;
        ...
        this.settings = $.extend({
            ...
            mapHeight: "400px",
            markerPosition: this.latLng,
            markerAnimation: google.maps.Animation.DROP
        }, options);
        this.init();
    };
    TanlinellResponsiveMaps.prototype.init = function() {
        var _this = this;
        this.createMap();
        this.addMarker();
    };
    TanlinellResponsiveMaps.prototype.createMap = function() {
        var _this = this;
        ...
        this.$el.css("height", this.settings.mapHeight);
    };
    TanlinellResponsiveMaps.prototype.addMarker = function() {
        var _this = this;
        var marker = new google.maps.Marker({
            map: this.map,
            position: this.settings.markerPosition,
            animation: this.settings.markerAnimation
        });
    };
    SITE.widgets.TanlinellResponsiveMaps = TanlinellResponsiveMaps;
})(jQuery);
...
(function($) {
    ...
    TanlinellAccordion.prototype.init = function() {
        ...
        this.open(this.$el.children(".is-active").eq(0));
        this.$el.addClass("js-accordian--active");
    ...
    TanlinellAccordion.prototype.closeAll = function(ele) {
        var _this = this;
        $.each(this.$panels, function(index, value) {
            _this.close($(this));
        });
    ...
    TanlinellAccordion.prototype.open = function(ele) {
        ...
        ele.prev(".js-accordion__heading").addClass("is-active").attr("aria-expanded", "true");
    };
    TanlinellAccordion.prototype.close = function(ele) {
        ele.removeClass("is-active");
        ele.attr("aria-hidden", "true");
        ele.prev(".js-accordion__heading").removeClass("is-active").attr("aria-expanded", "false");
    };
...
WebFontConfig = {
    google: {
        families: [ "Open+Sans:300,700:latin" ]
    }
};
...
(function($) {
    ...
    (function() {
        Modernizr.load({
            test: 1,
            yep: [ tanlinellSiteDetails.templateDirectoryUri + "/assets/js/conditional/masonry.pkgd.js" ],
            complete: function() {
                $(window).load(function() {
                    if (typeof Masonry !== "undefined") {
                        var container = $(".js-masonary-grid")[0];
                        if (container) {
                            var msnry = new Masonry(container, {
                                itemSelector: ".js-masonary-grid__item"
                            });
                        }
                    }
                });
    ...
    (function() {
        Modernizr.load({
            test: $(".gallery").length,
            yep: [ tanlinellSiteDetails.templateDirectoryUri + "/assets/js/conditional/magnific.min.js" ],
            complete: function() {
    ...
    (function() {
        Modernizr.load({
            test: $(".social-actions").length,
            yep: [ tanlinellSiteDetails.templateDirectoryUri + "/assets/js/conditional/socialite/socialite.min.js" ],
            complete: function() {
...
(function($) {
    $(document).ready(function() {
        Modernizr.load({
            test: SITE.utils.activeMQ > 4 && SITE.utils.cutsTheMustard && $(".js-location-map").length,
            yep: "https://maps.googleapis.com/maps/api/js?key=AIzaSyAR8gUKbD_LxzAxoknUzCq1x806pmpV1ZI&sensor=false&callback=tanlinellInitalizeGoogleMap",
            complete: function() {}
        });
    });
})(jQuery);

function tanlinellInitalizeGoogleMap() {
    var locationMap = new SITE.widgets.TanlinellResponsiveMaps($(".js-location-map"), {
        mapHeight: "500"
    });
}
...
(function() {
    Modernizr.load({
        test: $(".js-home-hero").length,
        yep: [ tanlinellSiteDetails.templateDirectoryUri + "/assets/js/conditional/jquery.anystretch.min.js" ],
        complete: function() {
            if (jQuery().anystretch) {
                var activeMQ = SITE.utils.activeMQ;
                var win_height = $(window).height();
                var banner_height = $(".banner").height();
                var hero_banner = $(".js-home-hero");
                var target_height = win_height - banner_height < 400 ? "400" : win_height - banner_height;
                hero_banner.css("height", target_height);
                var data_src = hero_banner.data("stretch-" + activeMQ);
                if (data_src === undefined) {
                    data_src = hero_banner.data("stretch-default");
                }
                hero_banner.anystretch(data_src, {
                    speed: 150,
                    positionX: "center",
                    positionY: "center"
                }).addClass("is-active");
...
(function($) {
    $(document).ready(function() {
        $(".js-distributor-filter select").on("change", function(e) {
            e.preventDefault();
